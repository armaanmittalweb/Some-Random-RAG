/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c8765c1bb5f4476144b705b46c85af18)
// Runtime types generated with workerd@1.20260921.1 2026-01-01 nodejs_compat
interface __BaseEnv_Env {
	GEMINI_API_KEY: string;
	GEMINI_MODEL: string;
	GEMINI_FALLBACK_MODEL: string;
	GEMINI_SIMILARITY_MODEL: string;
	GEMINI_EMBEDDING_MODEL: string;
	MONGODB_URI: string;
	MONGODB_DB: string;
	MONGODB_COLLECTION: string;
	MONGODB_CACHE_COLLECTION: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GEMINI_API_KEY" | "GEMINI_MODEL" | "GEMINI_FALLBACK_MODEL" | "GEMINI_SIMILARITY_MODEL" | "GEMINI_EMBEDDING_MODEL" | "MONGODB_URI" | "MONGODB_DB" | "MONGODB_COLLECTION" | "MONGODB_CACHE_COLLECTION" | "MONGODB_VECTOR_INDEX" | "PORT">> {}
}
